...
#define WIDTH_SPACE      75.f     // 가로 여유공간
...
- (CGSize)getBoxSize:(NSString *)string {
    CGSize maxSize = CGSizeMake(170.0, 30);  // 도움말 박스 크기의 최댓값을 설정합니다.
    
    UIFont *font = [UIFont fontWithName:@"Helvetica" size:10];
    CGSize dataHeight = [string sizeWithFont:font constrainedToSize:maxSize lineBreakMode:NSLineBreakByCharWrapping];
